...
class Cd:
    def __init__(self, internal_id, friendly_id, denumire, tip_aparat, stare_cone, cod_societ, cod_zona, serie_nod, nr_nod, POINT_X, POINT_Y, POINT_M, ignored=False):
