...
class BMP:
    def __init__(self, internal_id, friendly_id, denumire, serie_cont, stare_cone, serie_con2, serie_con3, serie_con4, serie_con5, cod_societ, cod_zona, nr_nod, serie_nod, POINT_X, POINT_Y, POINT_Z, POINT_M, ignored=False):
